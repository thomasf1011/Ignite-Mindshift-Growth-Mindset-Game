...
def intro():
  ...
  while user_input not in intro_options:
    ...
    user_input = str(input(" Type 'start' to start. \n"))
...
def fastfood():
  ...
  while user_input not in fastfood_options:
    print                 (r""" 
     ...
     """)
    print(''' \n \n You have gotten a job as a minimum wage employee at a local fast food chain. The pay is just barely enough to get by, and you have nothing to show for it but your shabby apartment. You  work there for two years, hating your job and resenting the way your life is going. One day, you are offered a promotion to assistant manager.   
  
    1) I don't think I'm management material. Back to flipping burgers. 
    2) I don't think I am suited for a management position, but I feel I do good work 
...
def ff03_3real():
 ...
 ''')
    print(''' \n \n Congratulations! You have gotten a job in the corporate offices of the fast food chain. You will hold this steady job for a number of years.  
  ...
  while user_input not in cc02_2_2_options:
    ...
    && %&% %&%& %&% %&%'
     ...
     \\/;:   \'--' `---`           `\\//-\\///
                           ...
                           """)
    print(''' \n \n You have reached retirement. You have enough money to live off of, asnd despite your insatisfaction with your career, you're glad you at least got to make it far in your field. Time to relax. 
