...
#done
def fastfoodcc():
  fastfoodcc_options = ["1","2","3"]
  user_input = ""
  while user_input not in fastfoodcc_options:
    print                 (r""" 
    ...
    1) I don't think I'm management material. Back to flipping burgers. 
    2) I think I made a mistake by dropping out of college. I'm gonna try again.
    3) I have to take advantage of this opportunity. I have no management experience,
    but I can learn, and I'm confident I'll do a great job.
    ''')
    ...
    user_input = str(input("What will you do?"))
  print ("You have selected " + user_input)
  if user_input == fastfoodcc_options[0]:
    ff01()
  elif user_input == fastfoodcc_options[1]:
    ff02()
  elif user_input == fastfoodcc_options[2]:
    ff03()
#done
def fastfooduni():
  fastfooduni_options = ["1","2","3"]
  user_input = ""
  while user_input not in fastfooduni_options:
    print                 (r""" 
    ...
    1) I don't think I'm management material. Back to flipping burgers. 
    2) I think I've made some mistakes. I'm gonna go back to college.
    3) I have to take advantage of this opportunity. I have no management experience,
    but I can learn, and I'm confident I'll do a great job.
    ''')
    ...
    user_input = str(input("What will you do?"))
  print ("You have selected " + user_input)
  if user_input == fastfooduni_options[0]:
    ff01()
  elif user_input == fastfooduni_options[1]:
    ff02()
  elif user_input == fastfooduni_options[2]:
    ff03()
#done
def ff01():
  ff01_options = ["1","2"]
